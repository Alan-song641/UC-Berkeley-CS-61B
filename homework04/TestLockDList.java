...
public class TestLockDList {
  public static void main (String[] args) {
    ...
    LockDList sl1 = new LockDList();     //看到没！要用子类中的新内容，创建的dynamic type必须是子类的！
    ...
    newtest(sl1);   //看到没！要用子类中的新内容，创建的dynamic type必须是子类的！
  ...
  private static void testEmpty() {
    LockDList lst1 = new LockDList();   //看到没！要用子类中的新内容，创建的dynamic type必须是子类的！
