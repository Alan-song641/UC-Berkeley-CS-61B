...
public class SList<size> {

    private SListNode head;
    private SListNode tail; //新建一个tail指针指向末尾，记得特殊情况，当size==0时怎么处理
    private int size;
    ...
    public void insertFront(Object obj) {
        head = new SListNode(obj, head);  //lecture 7的学习重点
        if(tail==null){
            tail=head;
        }
        size++;
    ...
    private static void testAfterInsertEnd() {
        ...
        SList test01=new SList();
        test01.insertFront(12);
        test01.insertFront(9);
        test01.insertFront(6);
        System.out.println(test01.toString());
        test01.insertFront(3);
        test01.insertEnd(15);
        System.out.println(test01.toString());
